   ...
   <script type="text/javascript">
	function ChangePrj(){
		 var url=window.location.toString();
	      if (url.toLowerCase().indexOf("tid=")>0)
	      {
	        url=url.substring(0,url.lastIndexOf("tid="));  
	        window.location= url+"tid="+document.getElementById('s_prj').value;
...
<div class="SubHeader">
    ...
    <ul class="Menu">
        ...
        <li><a href="<%=basePath %>allissue1?tid=<s:property value="#request.team.tid"/>" class="menu4 ">
            所有任务</a></li>
        <li><a href="<%=basePath %>issue_stat1?tid=<s:property value="#request.team.tid"/>" class="menu5 ">
            统计</a></li>
    </ul>
</div>
<!-- end of subheader-->
