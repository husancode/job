 ...
 <div class="Content">
        <div class="Right">
            ...
            <div class="relative CenterBox Sub">
                <form id="_form" action="<%=basePath %>projectscore" method="post">
                    ...
                    <span class="icon_bigest  left">
                     ...
                     <span class="icon_bigest left">
                        ...
                        搜索</span></a>	
                          ...
                          <a href="<%=basePath %>projectscore!scoreShow?did=<s:property value="#request.department.did" />"  class="button-create"><span>
                    查看修改</span></a>
                    <p class="clear box">
                        <!-- -->
                    </p>
            ...
            <!--start of solution-->
            <div class="Solution">
                <a href="#" onclick="score();" class="button-create"><span>
                    打分</span></a>
                <div class="PageTop">
                        	...
                        	<s:iterator value="#issue.issueWorkflows" var="workflow">
                        		<s:if test="#workflow.completeStatus==1">
                        			<s:property value="#workflow.toStaffer.name"/><b>:</b>
                        			 <!-- <input id="<s:property value="#workflow.id"/>" style="width: 40px" value="<s:property value="#issue.modular.score"/>"><br></br> -->
                     				<span name='span1'>
                     				...
                     				<select name="s2">
                     					<option value="0"   <s:if test="#issue.overLevel==0">selected="selected"</s:if> >0</option>
                     						<option value="-0.25"   <s:if test="#issue.overLevel==1">selected="selected"</s:if> >-0.25</option>
                     						<option value="-0.5"   <s:if test="#issue.overLevel==2">selected="selected"</s:if> >-0.5</option>
                     						<option value="-1"   <s:if test="#issue.overLevel==3">selected="selected"</s:if> >-1</option>
