...
<table align="center">
	<tr>
		<td align="center">
		<h2 style="font-size: 23; font-family: 黑体; letter-spacing: 4px">企划部月度个人绩效评分表（员工版1.2）
		</h2>
		</td>
	</tr>
</table>
...
<table width="624px" class="center" id="main1" align="center"
	...
	<tr height="40px" style="font-size: 15; ">
		<td  colspan="24" style="font-size: 16;font-family: 黑体; " align="left">综合分</td>
	</tr>
	<tr height="40px" style="font-size: 15; ">
		<td colspan="4">工作量(0.1):</td>
		<td colspan="4">工作态度(0.2)</td>
		<td colspan="4">团队协作(0.1)</td>
		<td colspan="4">劳动纪律(0.1)</td>
		<td colspan="4">工作进度(0.1)</td>
		<td colspan="4">校对得分(0.1)</td>
	</tr>
	<tr height="40px" style="font-size: 15; ">
		<td colspan="4"></td>
		<td colspan="4"></td>
