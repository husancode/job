    ...
    <div class="Content">
        <div class="Right">
            ...
            <div class="relative CenterBox Sub">
                <form id="_form" action="<%=basePath %>allissue" method="post">
                <input id="exportFlag" value="" name="exportFlag" type="hidden"></input>
                ...
                <div id="SearchBox" class="SearchBox left">
                    ...
                    <a href="javascript:SubmitForm('_form');" class=" Buttom "><span>
                        搜索</span></a>
                    <a href="javascript:exportForm();" class=" Buttom " style="margin-left: 20px"><span>导出任务</span></a>
                    <p class="clear box">
                        <!-- -->
                    </p>
                </div>
            ...
            <!--start of solution-->
            <div class="Solution">
                <a href="<%=basePath %>issueadd?did=<s:property value="#request.department.did" />" class="button-create"><span>
                    提交新任务</span></a>
                <div class="PageTop">
